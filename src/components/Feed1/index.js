...
const Feed = () => {
  ...
  // const messageTextInput = React.createRef();
  ...
  let unique = [
    ...new Map(clients.clients.map(item => [item['_id'], item])).values(),
  ];
  // console.log(unique);
  ...
  // };
  // console.log(clients.clients.filter(distinct));
  // console.log(clients.clients[0].branches[0].branchName);
  // console.log(loading);
