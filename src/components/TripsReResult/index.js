...
const TripsReResult = props => {
  ...
  const goToPostPage = data => {
    ...
    if (!loading) {
      ...
      // console.log(
      //   route.params.rebookingData,
      //   route.params.tripId,
      //   route.params.body1,
      // );
      navigation.navigate('ReBookTicket', {
        id: data.id,
        compId: data.compId,
        rebookingData: route.params.rebookingData,
        tripId: route.params.tripId,
        body: route.params.body,
        body1: route.params.body1,
      });
    }
  };
